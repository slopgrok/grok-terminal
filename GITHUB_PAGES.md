...
1. Go to your repository on GitHub: https://github.com/slopgrok/grok-terminal
2. Click on 'Settings' > 'Pages' in the sidebar.
3. Under 'Source', select the `master` branch and set the folder to `/ (root)`.
4. Save the settings. Your site will be published at https://slopgrok.github.io/grok-terminal/
